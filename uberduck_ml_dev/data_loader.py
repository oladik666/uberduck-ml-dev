...
__all__ = ['TextMelDataset', 'TextMelCollate', 'AudioMelDataset']
...
class AudioMelDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        print(audiopath)
        sample_rate, audio = read(audiopath)
        audio = audio / self.max_wav_value
        # TODO(zach): Find out why the original hifi GAN does this?
        ...
        if self.fine_tuning:
            raise Exception("fine tuning not yet supported")
        else:
            if self.split:
        ...
        mel_loss = self.stft_for_loss.mel_spectrogram(audio)
